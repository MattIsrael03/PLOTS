...
print("Select Bar Chart Data File")
bar_file = select_file()
print("Select Sankey Data File")
sankey_file = select_file()
print("Select Network Data File")
network_file = select_file()

bar_data = pd.read_csv(bar_file)
sankey_data = pd.read_csv(sankey_file)
